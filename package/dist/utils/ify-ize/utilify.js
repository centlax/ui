 ...
 */
export function stylify(styles) {
    return styles;
}
 ...
 */
export function variantify(variant, color) {
 ...
 */
export function stringify(...objs) {
    return objs
        .flatMap((obj) => typeof obj === 'object' ? Object.values(obj).filter((value) => typeof value !== 'object') : [])
        .join(' ');
}
