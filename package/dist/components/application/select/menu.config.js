export const props = {
    ...
    overflow: true /** Whether to prevent text selection overflowing the select when it is the top layer. */,
    portal: null,
    hover: true /** When true, hovering an option will update the highlightedItem store, and when the cursor leaves an option the store will be set to null */,
    open: false
};
/**
