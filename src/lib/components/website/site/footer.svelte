...
<footer class="bg-white pb-8 pt-16 dark:bg-neutral-900/50 sm:pt-24 lg:pt-32">
	...
	>
		...
		<form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
			...
			<input
				...
				autocomplete="email"
				required
				class="w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-1.5 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-neutral-500 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:w-56 sm:text-sm/6"
	...
	<div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
		...
		<p class="mt-8 text-sm/6 text-neutral-600 dark:text-neutral-400 md:order-1 md:mt-0">
			{@html props.notice}
		</p>
	</div>
</footer>
