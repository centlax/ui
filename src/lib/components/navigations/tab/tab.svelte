...
<div class="pt-6">
	<Tabs.Root
		value="outbound"
		class="w-[390px] rounded-md border border-gray-300/50 dark:border-gray-700/50 bg-background-alt p-3 shadow-card"
	>
		<Tabs.List
			...
			<div class="grid grid-cols-3 grid-rows-2 gap-0 p-4 pb-1">
				...
				<div class="relative col-span-3">
					...
					<div class="absolute left-1/2 -translate-x-1/2 bg-background-alt p-1">
						<UIcon
							name="i-fluent-airplane-24-regular"
							class="size-6 rotate-90 text-muted-foreground"
						/>
					</div>
				</div>
			</div>
