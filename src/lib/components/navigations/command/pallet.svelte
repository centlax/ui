<script lang="ts">
	const css = {
		list: 'cursor-default select-none rounded-md px-4 py-2 hover:bg-primary-600  hover:text-white'
	};
</script>
      ...
      -->
		...
		>
			...
			>
				...
				<li class={css.list} id="option-1" tabindex="-1">Leslie Alexander</li>
				<li class={css.list} id="option-2" tabindex="-1">Michael Foster</li>
				<li class={css.list} id="option-3" tabindex="-1">Dries Vincent</li>
				<li class={css.list} id="option-4" tabindex="-1">Lindsay Walton</li>
				<li class={css.list} id="option-5" tabindex="-1">Courtney Henry</li>
			</ul>
