...
export interface ClassType {
	 ...
	 * @see https://tailwindcss.com/docs/scale
	 **/
	motion?: ClassType['transition'] | ClassType['animation'] | ClassType['transform'];
	/**
...
export interface Styles {
	[key: string]: ClassType | Styles;
}

/**
 * Define a type for deeply nested styles, merging with ClassType
 */
export type DeepStyle<T> = {
	[K in keyof T]?: T[K] extends object ? DeepStyle<T[K]> & ClassType : T[K];
};
