...
<div class="flex rounded-md bg-white p-1 shadow-md" use:melt={$menubar}>
	...
	<div class=" menu" use:melt={$menuA}>
		...
		<div class="separator" use:melt={$separatorA}>
			...
			<div use:melt={$separatorA} class="separator"></div>
		...
		<div class=" menu" use:melt={$menuB}>
			...
			<div class="separator" use:melt={$separatorB}></div>
			<div class="item" use:melt={$subTriggerB}></div>
			Appearance
			<div class="rightSlot">></div>
		</div>
	...
	<div class=" menu" use:melt={$menuC}>
		...
		<div class="separator" use:melt={$separatorC}></div>
		...
		<div use:melt={$separatorC} class="separator"></div>
...
<style lang="postcss">
	...
	.trigger {
		...
		@apply text-primary-900 transition-colors hover:bg-white/90 data-[highlighted]:outline-none;
		@apply data-[highlighted]:bg-primary-200 data-[highlighted]:ring-primary-400 overflow-visible !important;
