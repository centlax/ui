		...
		>
			<div class="relative flex items-center">
				<a class="mr-3 w-[2.0625rem] flex-none overflow-hidden md:w-auto" href="/"
					><span class="sr-only">Tailwind CSS home page</span><svg
						viewBox="0 0 248 31"
						class="h-5 w-auto text-slate-900 dark:text-white"
						><path
							fill-rule="evenodd"
							clip-rule="evenodd"
				...
				<div class="relative" data-headlessui-state="">
					<button
						class="dark:highlight-white/5 flex items-center space-x-2 rounded-full bg-slate-400/10 px-3 py-1 text-xs font-semibold leading-5 hover:bg-slate-400/20"
						id="headlessui-menu-button-:r1:"
						type="button"
						aria-haspopup="menu"
						aria-expanded="false"
						data-headlessui-state=""
						>v3.4.17<svg width="6" height="3" class="ml-2 overflow-visible" aria-hidden="true"
							><path
								d="M0 0L3 3L6 0"
								fill="none"
								stroke="currentColor"
						...
						<ul class="flex space-x-8">
							...
							<li>
								<a
									...
									class="hover:text-sky-500 dark:hover:text-sky-400">Components</a
								>
							</li>
