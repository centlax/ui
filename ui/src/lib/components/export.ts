...
export { default as UDockbar } from '$lib/components/common/dockbar/dockbar.svelte';
...
export { default as UPriceLayout } from '$lib/components/website/price/layout.svelte';
